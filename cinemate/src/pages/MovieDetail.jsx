    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <p className="my-4">
            <span className="mr-2 font-bold">You Can watch the tailer here:</span>
            <a className="text-red-300" href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">{movie.imdb_id}</a>
          </p>
